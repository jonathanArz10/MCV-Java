    ...
    <body>
        ...
        <div class="video-container vertical-center">
            <div class="front absolute card col-xs-12">
                ...
                <form action="../../ProductsController.do" method="POST">
                    <input type="text" class="form-control" name="name" value="" placeholder="Escribe el nombre del producto " required><br>
                    <input type="text" class="form-control" name="price" value="" placeholder="Escribe el precio del producto " required><br>
                    <select id="categoria" class="form-control" name="category">
                    ...
                    <button type="submit" class="form-control" id="guardar">Guardar producto</button>
                </form>
            </div>
        </div>
    </body>
